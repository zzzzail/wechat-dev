...
?>
<link href="assets/index/css/5icool.org.css" type="text/css" rel="stylesheet" />
<script>
;(function($){
   var 
   //参数
...
<div class="upload-main">
  <div class="upload-box w1200">
    <h3 style="font-weight:700">图片管理</h3>
    <div class="up-list"  style="padding-bottom:100px">
      
	<div id="waterfall"  style="width:1200px; padding:0;">
			<?
...
?>
    <div class="cell" id=t<?=$rs["tid"]?> ><img src="<?=$f?>" /><p onclick="return dell(<?=$rs["tid"]?>)"  style="cursor:pointer; text-align:center; margin-left:40px; margin-top:5px; padding:0px 15px" class="delbtn">删除</p></div>
  <?
  }
  ?>
</div>
