...
<style type="text/css">
	...
	*
	...
	#biyeji_page0_0
	{
		top:  372px;
		left: 233px;
		background-image: url(http://t3.qpic.cn/mblogpic/0fc163f942a1b857639c/2000);
		width: 191px;
		height: 189px;
	}
	...
	#biyeji_page0_1
	{
		top:  220px;
		left: 280px;
		background-image: url(http://t3.qpic.cn/mblogpic/be1e361e63a0d2b946b2/2000);
		width: 155px;
		height: 152px;
	}
	...
	#biyeji_page0_2
	{
		top:  200px;
		left: 58px;
		background-image: url(http://t3.qpic.cn/mblogpic/733934e538d65d4da272/2000);
		width: 217px;
		height: 215px;
	...
	#biyeji_page1_0
	{
		top:  180px;
		left: 29px;
		background-image: url(<?=$p?>images/4.png);
		width: 305px;
		height: 239px;
	}
	...
	#biyeji_page1_1
	{
		top:  400px;
		left: 252px;
		background-image: url(<?=$p?>images/5.png);
		width: 150px;
		height: 148px;
	}
	...
	#biyeji_page1_2
	{
		top:  260px;
		left: 332px;
		background-image: url(<?=$p?>images/6.png);
		width: 130px;
		height: 125px;
	}
	...
	#biyeji_page1_3
	{
		top:  430px;
		left: 88px;
		background-image: url(<?=$p?>images/7.png);
		width: 135px;
		height: 131px;
	}
	...
	#biyeji_page2_0
	{
		top: 230px;
		left: 62px;
		background-image: url(<?=$p?>images/8.png);
		width: 377px;
		height: 286px;
	}
	...
	#biyeji_page3_0
	{
		top: 385px;
		left: 231px;
		background-image: url(<?=$p?>images/9.png);
		width: 235px;
		height: 169px;
	}
	...
	#biyeji_page3_1
	{
		top: 170px;
		left: 45px;
		background-image: url(<?=$p?>images/10.png);
		width: 315px;
		height: 240px;
	}
	...
	#biyeji_page4_0
	{
		top: 168px;
		left: 50px;
		background-image: url(<?=$p?>images/11.png);
		width: 262px;
		height: 260px;
	}
	...
	#biyeji_page4_1
	{
		top: 392px;
		left: 265px;
		background-image: url(<?=$p?>images/12.png);
		width: 174px;
		height: 179px;
	}
	...
	#biyeji_page5_0
	{
		top: 398px;
		left: 193px;
		background-image: url(<?=$p?>images/13.png);
		width: 232px;
		height: 225px;
	}
	...
	#biyeji_page5_1
	{
		top: 210px;
		left: 40px;
		background-image: url(<?=$p?>images/14.png);
		width: 292px;
		height: 229px;
	}
...
<div id='biyeji_container'>
	...
	<img id='biyeji_background' src='<?=$p?>images/bg.jpg'>
	...
	<img src='<?=$p?>images/1.png' style='position:absolute;top:-100px;left:200px;width:60px;-webkit-animation:piaoluo 10s linear infinite'>
	<img src='<?=$p?>images/2.png' style='position:absolute;top:-100px;left:300px;width:40px;-webkit-animation:piaoluo 10s linear 2.5s infinite'>
	<img src='<?=$p?>images/3.png' style='position:absolute;top:-100px;left:400px;width:50px;-webkit-animation:piaoluo 10s linear 7.5s infinite'>
	<img src='<?=$p?>images/1.png' style='position:absolute;top:-100px;left:500px;width:60px;-webkit-animation:piaoluo 10s linear 5s infinite'>

    <div id='pagetitle' style='position:absolute;width:410px;height:200px;top:238px;left:45px;font-size:40px;color:#fff;overflow:hidden;text-shadow:5px 6px 4px rgba(0, 0, 0, 0.2);'>
        <div style='position:absolute;width:410px;height:200px;top:0px;left:0px;overflow:hidden;'>
            <div style='position:absolute;width:410px;height:200px;display:table;overflow:hidden;'>
                <div id='titlecontent' style='width:410px;height:200px;vertical-align:middle;display:table-cell;text-align:center;font-size:40px;line-height:70px;color:#DEA42E;'></div>
            </div>
        </div>
    </div>
...
<script>
	...
	function biyeji_showpage0 () 
	{
		...
		for(var i=0;i<3;i++)
		{
		    ...
		    {
		        console.log(Onload_image_urls[images_url_index]);
		        images_url_index++;
		        if(images_url_index == Onload_image_urls.length)
		            images_url_index = 0;
		    }
